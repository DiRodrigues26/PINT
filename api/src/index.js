...
const { iniciarJobExpiracao } = require('./jobs/badgeExpiracaoAlertas');
...
const templatesEmailRoutes = require('./routes/templatesEmailRoutes');
...
app.use('/api/templates-email',   templatesEmailRoutes);
