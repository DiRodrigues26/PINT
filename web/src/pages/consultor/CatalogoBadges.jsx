        ...
        {obtido ? (
          <div className="flex items-center justify-between text-xs">
            <span className="flex items-center gap-1 text-slate-500">
              ...
              Emitido: {formatarData(obtido.data_atribuicao)}
            </span>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between text-xs">
              <span className="font-semibold text-softinsa-600">Em Progresso</span>
    ...
    <div className="min-h-screen bg-[#f3f6fa]">
      ...
      <div className="lg:pl-[260px]">
        ...
        <main className="px-5 py-8 lg:px-10 pb-24 lg:pb-10">
          <h2 className="text-2xl font-bold text-slate-900">Catálogo de Badges</h2>
          ...
          {isLoading ? (
            ...
            <div className="mt-16 flex flex-col items-center text-center">
              ...
              <p className="mt-4 text-base font-semibold text-slate-600">Nenhum badge encontrado</p>
              <p className="mt-1 text-sm text-slate-400">Tenta ajustar os filtros de pesquisa.</p>
            </div>
          ) : (
